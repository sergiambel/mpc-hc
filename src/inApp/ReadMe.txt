========================================================================
    ACTIVE TEMPLATE LIBRARY : inApp Project Overview
========================================================================

AppWizard has created this inApp project for you to use as the starting point for
...
inApp.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (inApp.h)
        GUID definitions                                (inApp_i.c)
        A type library                                  (inApp.tlb)
        Marshaling code                                 (inApp_p.c and dlldata.c)

inApp.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in inApp.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named inApp.pch and a precompiled types file named StdAfx.obj.
...
inAppps.vcxproj
	...
	dlldata.c, inApp_i.c and inApp_p.c which are required
	to build the proxy/stub DLL.

inAppps.vcxproj.filters
